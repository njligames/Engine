...
void printGLInfo()
{
    ...
    //TODO:error: use of undeclared identifier 'GL_MAX_VERTEX_UNIFORM_VECTORS' glGetIntegerv(GL_MAX_VERTEX_UNIFORM_VECTORS, &param);
    DEBUG_LOG_V(TAG, "%s = %d\n", "The maximumum amount of uniform vectors in the vertex shader", param);
    
    //TODO:error: use of undeclared identifier 'GL_MAX_FRAGMENT_UNIFORM_VECTORS' glGetIntegerv(GL_MAX_FRAGMENT_UNIFORM_VECTORS, &param);
    DEBUG_LOG_V(TAG, "%s = %d\n", "The maximumum amount of uniform vectors in the fragment shader", param);
    
    //TODO: error: use of undeclared identifier 'GL_MAX_VARYING_VECTORS' glGetIntegerv(GL_MAX_VARYING_VECTORS, &param);
