...
class GLView extends GLSurfaceView {
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        ...
        private ArrayList<MotionEvent.PointerCoords> createTouchList(MotionEvent e)
        {
        	ArrayList<MotionEvent.PointerCoords> points = new ArrayList<MotionEvent.PointerCoords>();
        ...
        {
        	ArrayList<MotionEvent.PointerCoords> points = createTouchList(e);
